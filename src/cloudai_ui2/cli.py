...
"""CloudAI Web UI v2 CLI - Dash.plotly based."""
...
def main(results_dir: Path, host: str, port: int, debug: bool):
    """Run the CloudAI Web UI v2 Dash development server."""
    app = create_app(results_dir)

    click.echo("=" * 60)
    click.echo("CloudAI Web UI v2 (Dash.plotly)")
    click.echo("=" * 60)
    ...
    try:
        ...
        click.echo("\nShutting down CloudAI Web UI v2...")
