...
CloudAI can compare canonical workload metrics with configured Speed-of-Light (SOL) targets. SOL configuration is
...
measured, SOL, and percentage-of-SOL columns and draw the SOL as a dashed chart series.
