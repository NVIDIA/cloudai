...
@StrategyRegistry.strategy(ReportGenerationStrategy, [SlurmSystem], [NcclMiner])
class NcclMinerReportGenerationStrategy(ReportGenerationStrategy):
    """
    Strategy for generating reports from NcclMiner directories.
    """
