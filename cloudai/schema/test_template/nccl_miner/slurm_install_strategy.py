...
@StrategyRegistry.strategy(InstallStrategy, [SlurmSystem], [NcclMiner])
class NcclMinerSlurmInstallStrategy(SlurmInstallStrategy):
    """
    Install strategy for NCCL Miner on Slurm systems.
    ...
    SUBDIR_PATH = "nccl-miner"
    DOCKER_IMAGE_FILENAME = "nccl_miner.sqsh"
