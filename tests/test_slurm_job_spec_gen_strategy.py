...
class TestJaxToolboxSlurmJobSpecGenStrategy__ExtractTestName:
    ...
    def test_combine_fdl_flags(self, jax_strategy_fixture: JaxToolboxSlurmJobSpecGenStrategy):
        cmd_args = {
    ...
    def test_combine_fdl_flags_override(self, jax_strategy_fixture: JaxToolboxSlurmJobSpecGenStrategy):
        cmd_args = {
            "common.fdl.some_flag": "value",
    ...
    def test_get_fdl_config_value(self, jax_strategy_fixture: JaxToolboxSlurmJobSpecGenStrategy):
        cmd_args = {
    ...
    def test_get_fdl_config_value_missing(self, jax_strategy_fixture: JaxToolboxSlurmJobSpecGenStrategy):
        cmd_args = {}
        jax_strategy_fixture.test_name = "Grok"
        config_value = jax_strategy_fixture._get_fdl_config_value(cmd_args)
...
class TestWriteSbatchScript:
    ...
    def test_extra_args(
        self, arg: str, arg_value: str, expected_str: str, strategy_fixture: SlurmJobSpecGenStrategy, tmp_path: Path
    ):
        args = self.MANDATORY_ARGS.copy()
        args[arg] = arg_value
