...
def test_filename_generation(strategy_fixture: SlurmCommandGenStrategy, testrun_fixture: TestRun):
    ...
    slurm_args = strategy_fixture._parse_slurm_args(job_name_prefix, env_vars, testrun_fixture)
    srun_command = strategy_fixture._gen_srun_command(slurm_args, env_vars, testrun_fixture)
...
def test_num_nodes_and_nodes(strategy_fixture: SlurmCommandGenStrategy):
    ...
    slurm_args = strategy_fixture._parse_slurm_args(job_name_prefix, env_vars, tr)
