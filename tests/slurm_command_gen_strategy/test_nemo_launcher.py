...
class TestNeMoLauncherSlurmCommandGenStrategy__GenExecCommand:
    ...
    def test_generate_exec_command(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
        cmd = cmd_gen_strategy.gen_exec_command(nemo_test_run)
    ...
    def test_env_var_escaping(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
    ...
    def test_tokenizer_handled(
        self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun, tmp_path: Path
    ):
    ...
    def test_reservation_handled(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
        cmd_gen_strategy.system.extra_srun_args = "--reservation my-reservation"
        cmd = cmd_gen_strategy.gen_exec_command(nemo_test_run)

        assert "+cluster.reservation=my-reservation" in cmd

    def test_invalid_tokenizer_path(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
        ...
        with pytest.raises(
            ...
            cmd_gen_strategy.gen_exec_command(nemo_test_run)

    def test_account_in_command(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
    ...
    def test_no_account_in_command(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
    ...
    def test_gpus_per_node_value(self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun):
    ...
    def test_data_impl_mock_skips_checks(
        self, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun
    ):
    ...
    def test_log_command_to_file(
        self, mock_file, cmd_gen_strategy: NeMoLauncherSlurmCommandGenStrategy, nemo_test_run: TestRun, tmp_path: Path
    ):
