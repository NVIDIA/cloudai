...
def test_validate_domain_randomization_active_allows_live_rl_run() -> None:
    ...
    validate_domain_randomization_active(TestScenario(name="s", test_runs=[tr]))  # no exception == pass
