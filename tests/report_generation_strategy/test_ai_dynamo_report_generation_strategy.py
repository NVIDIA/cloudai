...
def get_csv_content() -> str:
    return (
        ...
        'Time To First Token (ms),111.11,222.22,"333.33","444.44","555.55","666.66",777.77,888.88,999.99\n'
        "Time To Second Token (ms),11.11,22.22,33.33,44.44,55.55,66.66,77.77,88.88,99.99\n"
        'Request Latency (ms),"1111.11","2222.22","3333.33","4444.44","5555.55","6666.66",'
