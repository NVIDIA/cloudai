...
from cloudai.workloads.nccl_test import NCCLTestKubernetesJobGenStrategy
...
def create_test_run(config: Dict[str, Any] | None = None):
    ...
    return MockTestRun("test-nccl", test)


class TestNCCLTestKubernetesJobGenStrategy:
    def test_generate_spec(self):
        strategy = NCCLTestKubernetesJobGenStrategy()
